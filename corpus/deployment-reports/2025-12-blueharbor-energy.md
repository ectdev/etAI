# Blueharbor Energy, 2025-12

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

5 of 8 repositories are now running on Halcyon, targeting `gcp`.

## Timings

The pipeline the customer measures us on ran in 68 minutes on the old system and
runs in 29 minutes here. Both numbers are the median of the month rather than a best
