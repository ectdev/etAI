# Corvid Analytics, 2026-01

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

9 of 21 repositories are now running on Halcyon, targeting `fly`.

## Timings

The pipeline the customer measures us on ran in 76 minutes on the old system and
