# Kestrel Freight, 2025-12

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

13 of 14 repositories are now running on Halcyon, targeting `aws`.

## Timings

The pipeline the customer measures us on ran in 56 minutes on the old system and
runs in 26 minutes here. Both numbers are the median of the month rather than a best
