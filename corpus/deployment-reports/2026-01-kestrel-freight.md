# Kestrel Freight, 2026-01

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

1 of 14 repositories are now running on Halcyon, targeting `aws`.

## Timings

The pipeline the customer measures us on ran in 80 minutes on the old system and
runs in 42 minutes here. Both numbers are the median of the month rather than a best
