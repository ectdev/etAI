# Corvid Analytics, 2025-11

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

13 of 21 repositories are now running on Halcyon, targeting `fly`.

## Timings

The pipeline the customer measures us on ran in 108 minutes on the old system and
runs in 40 minutes here. Both numbers are the median of the month rather than a best
