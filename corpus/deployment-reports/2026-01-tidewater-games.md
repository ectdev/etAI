# Tidewater Games, 2026-01

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

3 of 4 repositories are now running on Halcyon, targeting `hetzner`.

## Timings

The pipeline the customer measures us on ran in 136 minutes on the old system and
runs in 75 minutes here. Both numbers are the median of the month rather than a best
