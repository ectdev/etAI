...
1 of 2 repositories are now running on Halcyon, targeting `fly`.

## Timings

The pipeline the customer measures us on ran in 156 minutes on the old system and
runs in 80 minutes here. Both numbers are the median of the month rather than a best
