# Fernwood Bank, 2026-03

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

8 of 18 repositories are now running on Halcyon, targeting `hetzner`.

## Timings

The pipeline the customer measures us on ran in 52 minutes on the old system and
runs in 27 minutes here. Both numbers are the median of the month rather than a best
