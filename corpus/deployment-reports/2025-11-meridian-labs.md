# Meridian Labs, 2025-11

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

1 of 7 repositories are now running on Halcyon, targeting `hetzner`.

## Timings

The pipeline the customer measures us on ran in 144 minutes on the old system and
runs in 88 minutes here. Both numbers are the median of the month rather than a best
