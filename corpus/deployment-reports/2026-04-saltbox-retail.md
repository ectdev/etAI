# Saltbox Retail, 2026-04

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

5 of 11 repositories are now running on Halcyon, targeting `aws`.

## Timings

The pipeline the customer measures us on ran in 64 minutes on the old system and
runs in 31 minutes here. Both numbers are the median of the month rather than a best
