# Tidewater Games, 2026-04

Status: migration in progress. The old system is still running and will be switched off at handover.

## Moved this month

2 of 4 repositories are now running on Halcyon, targeting `hetzner`.

## Timings

The pipeline the customer measures us on ran in 116 minutes on the old system and
runs in 61 minutes here. Both numbers are the median of the month rather than a best
