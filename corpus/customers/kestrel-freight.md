...
Sector: logistics. Tier: Scale. Repositories in scope: 14.

## Where they are coming from

Kestrel Freight runs Jenkins today. The reason they are moving is a nightly suite that had grown to four hours. Their longest
pipeline currently takes 52 minutes, and that number is the one they will judge us on.
