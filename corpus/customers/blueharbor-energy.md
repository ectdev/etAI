...
Sector: energy. Tier: Scale. Repositories in scope: 8.

## Where they are coming from

Blueharbor Energy runs Azure Pipelines today. The reason they are moving is a pipeline definition nobody could read any more. Their longest
pipeline currently takes 55 minutes, and that number is the one they will judge us on.
