...
Sector: health records. Tier: Scale. Repositories in scope: 9.

## Where they are coming from

Runeberg Health runs GitLab CI today. The reason they are moving is a compliance review that needed a fixed source address. Their longest
pipeline currently takes 1 hour 12 minutes, and that number is the one they will judge us on.
