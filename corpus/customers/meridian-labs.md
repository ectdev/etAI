...
Sector: instrumentation. Tier: Scale. Repositories in scope: 7.

## Where they are coming from

Meridian Labs runs Buildkite today. The reason they are moving is simulation runs that no hosted runner would finish. Their longest
pipeline currently takes 3 hours 20 minutes, and that number is the one they will judge us on.
