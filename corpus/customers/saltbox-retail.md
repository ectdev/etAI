...
Sector: retail. Tier: Scale. Repositories in scope: 11.

## Where they are coming from

Saltbox Retail runs Bitbucket Pipelines today. The reason they are moving is artifacts that had quietly grown past 4 GB. Their longest
pipeline currently takes 1 hour 5 minutes, and that number is the one they will judge us on.

## Target

Primary target provider is `aws`, chosen against the limits in that provider's
