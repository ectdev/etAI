...
Sector: logistics. Tier: Starter. Repositories in scope: 5.

## Where they are coming from

Postmark Logistics runs CircleCI today. The reason they are moving is a per minute bill that had doubled in a year. Their longest
pipeline currently takes 31 minutes, and that number is the one they will judge us on.
