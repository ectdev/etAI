...
Sector: games. Tier: Scale. Repositories in scope: 4.

## Where they are coming from

Tidewater Games runs TeamCity today. The reason they are moving is asset builds that needed a GPU and twelve hours. Their longest
pipeline currently takes 2 hours 40 minutes, and that number is the one they will judge us on.
